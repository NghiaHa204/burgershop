...
INSERT INTO `bills` (`id`, `user_id`, `date_bill`, `timeid`, `address`, `van_chuyen`, `total_money`, `trang_thai`, `username`) VALUES
	...
	(12, 8, '2024-12-15', '113522', 'josbjkasjs', '3', '135000', 'Vừa đặt', 'admin466');
...
INSERT INTO `bill_items` (`id`, `bill_timeid`, `title`, `count`, `price`) VALUES
	...
	(16, '113522', 'BURGER BÒ TEMPURA JR', 2, '67.5');
...
-- Dumping data for table burgershop.menu_items: ~52 rows (approximately)
INSERT INTO `menu_items` (`id`, `type`, `image`, `title`, `content`, `price`, `item_id`) VALUES
	...
	(2, 'burger', 'img/water2.jpg', 'milo', 'milo', '26.500.000 VND', 2),
...
-- Dumping data for table burgershop.users: ~4 rows (approximately)
INSERT INTO `users` (`id`, `name`, `email`, `phone_number`, `username`, `password`, `dateSignup`) VALUES
	...
	(8, 'absk sds', 'bnsa224@gmail.com', '0382755888', 'admin466', 'Admin466*', '2024-12-15');
